...
class ModelConfig:
    ...
    query_pre_attn_norm: QueryPreAttentionNormalisation = QueryPreAttentionNormalisation.BY_ONE_OVER_SQRT_HEAD_DIM
    shd_config: ShardingConfig = ShardingConfig.get_default_sharding()

    @classmethod
    def gemma3_1b(cls) -> "ModelConfig":
        return cls(
            num_layers=26,
            num_embed=262144,
            embed_dim=1152,
    ...
    @classmethod
    def gemma3_27b(cls) -> "ModelConfig":
