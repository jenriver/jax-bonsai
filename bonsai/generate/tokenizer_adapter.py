...
class TokenizerAdapter:
    ...
    def _is_hf_tokenizer(self) -> bool:
        ...
        baseclass_names = [baseclass.__module__ + "." + baseclass.__name__ for baseclass in baseclasses]
        if "transformers.tokenization_utils_base.PreTrainedTokenizerBase" in baseclass_names:
            return True
        return False
